      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto align-items-lg-center">
            <Nav.Link as={Link} to="/" onClick={() => setExpanded(false)} className={`fw-medium ${shouldBeSolid ? 'text-dark' : 'text-white opacity-90'}`}>Beranda</Nav.Link>
            <NavDropdown 
              title={<span className={`fw-medium ${shouldBeSolid ? 'text-dark' : 'text-white opacity-90'}`}>Profil</span>} 
              id="profil-nav-dropdown"
            >
              <NavDropdown.Item as={Link} to="/profil" onClick={() => setExpanded(false)}>Profil Pesantren</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/program" onClick={() => setExpanded(false)}>Program Pendidikan</NavDropdown.Item>
            </NavDropdown>
            ...
            <Nav.Link as={Link} to="/fasilitas" onClick={() => setExpanded(false)} className={`fw-medium ${shouldBeSolid ? 'text-dark' : 'text-white opacity-90'}`}>Fasilitas</Nav.Link>
