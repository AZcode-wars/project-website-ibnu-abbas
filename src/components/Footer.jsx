        ...
        <Row className="mb-5 gy-4">
          ...
          <Col lg={4} className="mb-lg-0">
            ...
            <div className="d-flex gap-3">
              <a href="https://maps.google.com/?q=Ma'had+Ibnu+Abbas+Banjarnegara+Dusun+Kayunan,+RT.+05/RW.+04,+Desa+Banjarmangu,+Kecamatan+Banjarmangu,+Kabupaten+Banjarnegara,+Jawa+Tengah+53452" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Lokasi Google Maps Pondok Pesantren Ibnu Abbas">
                <MapPin size={20} />
              </a>
          ...
          <Col lg={4}>
            ...
            <div className="footer-contact-item">
              ...
              <span>Dusun Kayunan, RT. 05/RW. 04, Desa Banjarmangu, Kecamatan Banjarmangu, Kabupaten Banjarnegara, Jawa Tengah 53452</span>
            </div>
            <div className="footer-contact-item">
