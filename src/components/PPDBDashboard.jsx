...
// ────────────────────────────────────────────
const PPDBDashboard = ({ settings, stats }) => {
            ...
            <div className="mb-4">
              ...
              <Accordion defaultActiveKey="0" className="ppdb-accordion">
                ...
                <Accordion.Item eventKey="2" className="ppdb-accordion-item">
                  ...
                  <Accordion.Body>
                    Informasi biaya lengkap dapat diunduh melalui brosur digital
                    kami atau ditanyakan langsung via WhatsApp admin.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
            </div>
              ...
              <div className="ppdb-cta-card position-relative overflow-hidden">
                <div className="position-relative" style={{ zIndex: 2 }}>
                  ...
                  <p className="lead mb-4 text-white opacity-85">
                    Klik tombol di bawah untuk terhubung langsung dengan panitia
